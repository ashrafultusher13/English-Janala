  ...
  words.forEach((word) => {
    ...
    <div
      ...
      >
        ...
        <div class="font-bangla text-2xl font-medium">"${word.meaning ? word.meaning : "শব্দের অর্থ পাওয়া যায়নি"} / ${word.pronunciation ? word.pronunciation : "উচ্চারণ পাওয়া যায়নি"}"</div>
